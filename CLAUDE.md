...
- `packages/card-mcp` — `@miguelarios/card-mcp` — CardDAV contacts MCP server
- `packages/email-mcp` — `@miguelarios/email-mcp` — IMAP/SMTP email MCP server
- `packages/cal-mcp` — `@miguelarios/cal-mcp` — CalDAV calendar MCP server
